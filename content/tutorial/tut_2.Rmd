...
<font size="-1"> There are many packages to run parallel processing in R. Here are a few examples:
...
Use the "parallel" library to detect the number of cores in your computer </font>
```{r}
library(parallel)
nc <- detectCores()
```
