...
Otherwise, there is an excellent book on the subject that is freely available to download at [Gotelli and Graves 1996](https://www.uvm.edu/~ngotelli/nullmodelspage.html)
...
```
This will create a _Parallel Socket Cluster_ (PSOCK), which can be done in all operating systems. However, it only starts with the base packages and thus you need to export variables, functions and packages to the cluster (see further below) if you need them in your parallel code.
